...
import sys
from utils import JackTokeniser, Initialiser, CompilationEngine

def main():
    """
    The driver for the Jack syntax analyser. Responsible for setting up and
    invoking Initialiser, JackTokeniser, and CompilationEngine. 
    """
    ...
    for input_file, output_file in file_names.items():
        ...
        engine = CompilationEngine(tokeniser, output_file)
